...
export default function TextArea() {
  ...
  function NewTab() {
    window.open(`https://meet.google.com/yud-ysmz-pmd`, "_blank")
  }
...
const MessageContainer = tw.div`
  flex flex-col w-full bg-sky-200/50 rounded-lg
`
...
const FileInput = tw.input`
  absolute top-0 left-0 w-full h-full text-[0px] z-10
  file:w-full file:h-full file:bg-transparent file:border-0
`

const TextInput = tw.div`
  py-2.5 w-full h-full bg-transparent font-medium text-gray-600 outline-0 outline-hidden break-all whitespace-pre-wrap
